...
export default function DashboardPage() {
  ...
  const totalVotes = polls.reduce(
    (sum, poll) =>
      sum + (poll.options?.reduce((pollSum: number, option: any) => pollSum + (option.votes || 0), 0) || 0),
    0
  );
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{totalPolls > 0 ? Math.round(totalVotes / totalPolls) : 0}</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="lg:col-span-2">
            ...
            {loading || authLoading ? (
              <div className="flex justify-center items-center py-12">
                <span className="text-gray-500 animate-pulse">Loading your polls...</span>
              </div>
            ) : error ? (
